  ...
  return (
    <div style={{ minHeight: '90vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)' }}>
      ...
      >
        ...
        <p style={{ textAlign: 'center', color: '#999', marginBottom: '2rem' }}>Login to your account</p>
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            required
            style={{ width: '100%', padding: '0.85rem 1rem', marginBottom: '1rem', border: '2px solid #eee', borderRadius: '10px', fontSize: '1rem', outline: 'none', boxSizing: 'border-box', transition: 'border-color 0.2s' }}
          ...
          <input
            ...
            required
            style={{ width: '100%', padding: '0.85rem 1rem', marginBottom: '1.5rem', border: '2px solid #eee', borderRadius: '10px', fontSize: '1rem', outline: 'none', boxSizing: 'border-box', transition: 'border-color 0.2s' }}
            onFocus={e => e.target.style.borderColor = '#e96c4c'}
            onBlur={e => e.target.style.borderColor = '#eee'}
          />
          <motion.button
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', color: '#999' }}>
          No account? <Link to="/register" style={{ color: '#e96c4c', fontWeight: 'bold' }}>Register here</Link>
        </p>
      </motion.div>
    </div>
  );
