          ...
          >
            ...
            >
              ...
              >
                <span
                  style={{
                    background: order.isPaid ? "#d4f5e9" : "#fff0eb",
                    color: order.isPaid ? "#1a7a4a" : "#c0392b",
                ...
                <span
                  style={{
                    background: order.isDelivered ? "#d4f5e9" : "#fff8e1",
                    color: order.isDelivered ? "#1a7a4a" : "#b8860b",
                    padding: "0.25rem 0.75rem",
                    borderRadius: "20px",
                    fontSize: "0.78rem",
                    fontWeight: "700",
                  ...
                  >
                    ...
                    {order.items.map((item, j) => (
                      ...
                      >
                        ...
                        <span style={{ fontWeight: "700", color: "#e96c4c" }}>
